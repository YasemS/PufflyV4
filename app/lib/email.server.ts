...
<html lang="en">
  ...
  <body>
    ...
    <p>
      ...
      <br />
      link: <a href="https://www.puffly.io/order/${opts.id}" target="_blank">view order</a>
      <br />
      items:
      <br />
      <ul>
...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>order pending - puffly</title>
    <style>
      body {
        font-family: Arial, sans-serif;
        background-color: #ffffff;
  ...
  <body>
    ...
    <p>we've received your order, it will be processed once we have received your payment via ${opts.payment}.</p>
...
we've received your order, it will be processed once we have received your payment via ${opts.payment}.
