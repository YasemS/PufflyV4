...
export default function Nav() {
  ...
  return (
    <nav className="sticky top-0 left-0 w-full h-16 px-8 bg-zinc-800/25 border-b border-zinc-800 backdrop-blur-xl z-10 sm:h-20">
      <Container className="flex items-center justify-center gap-4 h-full w-full sm:justify-between">
