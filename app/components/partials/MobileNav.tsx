...
function MobileNavLink({ icon, text, to, ...props }: MobileNavLinkProps) {
  return (
    <NavLink
      className={({ isActive }) =>
        cn(
          "flex flex-col gap-1 items-center justify-center border-r border-zinc-800 text-zinc-300",
...
export default function MobileNav() {
  return (
    <nav className="grid grid-cols-4 fixed bottom-0 left-0 w-full h-16 bg-zinc-950 border-y border-zinc-800 z-10">
